...
const unsigned long scrollInterval = 20; // czas między przesunięciami 2 lini w ms
...
void updateFFT() {
  ...
  int fftBottom = M5Cardputer.Display.height() - FOOTER_HEIGHT - 1;

  static unsigned long lastFFTUpdate = 0;
  if (millis() - lastFFTUpdate < 80) return;
